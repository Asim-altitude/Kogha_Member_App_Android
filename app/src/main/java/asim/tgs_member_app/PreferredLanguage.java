...
public class PreferredLanguage extends AppCompatActivity {
    ...
    private void setupToolbar(){
        ...
        ab.setTitle("Preferred Language");
    }
    private void LoadLocalConfigurations()
    {
        ...
        if (!language.equalsIgnoreCase(""))
        {
            ...
            else if (language.equalsIgnoreCase("Bahasa Malayu"))
            {
                ((RadioButton)findViewById(R.id.english_btn)).setChecked(false);
                ((RadioButton)findViewById(R.id.bahasa_btn)).setChecked(true);
                selected_language = "Bahasa Malayu";
    ...
    private void Changelanguage(final String locale)
    {
       /* AlertDialog.Builder builder = new AlertDialog.Builder(getApplicationContext())
        ...
        Toast.makeText(getApplicationContext(),"Your preferred language changed to "+selected_language,Toast.LENGTH_SHORT).show();
        finish();
