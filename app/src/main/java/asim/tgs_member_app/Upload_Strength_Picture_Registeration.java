...
public class Upload_Strength_Picture_Registeration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if (Constants.hasProfessionalImage) {
        ...
        btnSkip_upload_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), Upload_SideBody_Picture_Registeration.class)
                        .putExtra("profile", profile_image).putExtra("professional", ""));
                sharedPreferences.edit().putString(Constants.STRENGTH_DOC,"").apply();
                finish();
            }
        });
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isImageChosen) {
                    startActivity(new Intent(getApplicationContext(), Upload_SideBody_Picture_Registeration.class)
                            .putExtra("profile", profile_image).putExtra("professional", professional_image));
                    sharedPreferences.edit().putString(Constants.STRENGTH_DOC,professional_image).apply();
                    finish();
                }
                 else
                   UtilsManager.showAlertMessage(Upload_Strength_Picture_Registeration.this,"","Please choose a picture showing your full body strength.");
