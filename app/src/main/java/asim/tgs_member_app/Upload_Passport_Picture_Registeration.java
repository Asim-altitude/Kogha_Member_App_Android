...
public class Upload_Passport_Picture_Registeration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload__passport__picture__registeration);
        sharedPreferences = getSharedPreferences(Constants.PREFS_NAME,MODE_PRIVATE);
        /*if (Constants.hasProfessionalImage) {
            startActivity(new Intent(Upload_Passport_Picture_Registeration.this, Upload_Driving_License_Registeration.class).putExtra("professional", ""));
            finish();
        }*/
        ...
        String doc_name = sharedPreferences.getString(Constants.PASSPORT_DOC,"no");
        ...
        btnSkip_upload_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), Upload_Interior_Picture_Registeration.class));
                sharedPreferences.edit().putString(Constants.PASSPORT_DOC,"").apply();
                finish();
            }
        });
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isImageChosen) {
                    startActivity(new Intent(getApplicationContext(), Upload_Interior_Picture_Registeration.class));
                    sharedPreferences.edit().putString(Constants.PASSPORT_DOC,professional_image).apply();
                    finish();
                }
                 else
                    UtilsManager.showAlertMessage(Upload_Passport_Picture_Registeration.this,"","Please provide a document");
