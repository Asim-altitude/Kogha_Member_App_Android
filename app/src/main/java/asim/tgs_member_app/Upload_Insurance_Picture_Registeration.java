...
public class Upload_Insurance_Picture_Registeration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload__insurance__picture__registeration);
        sharedPreferences = getSharedPreferences(Constants.PREFS_NAME,MODE_PRIVATE);

       /* if (Constants.hasProfessionalImage) {
            startActivity(new Intent(Upload_Insurance_Picture_Registeration.this, Upload_Driving_License_Registeration.class).putExtra("professional", ""));
            finish();
        }*/
        ...
        btnSkip_upload_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),  Car_Details_Registeration.class));
                sharedPreferences.edit().putString(Constants.INSURANCE_DOC,"").apply();
                finish();
            }
        });
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isImageChosen) {
                    startActivity(new Intent(getApplicationContext(), Car_Details_Registeration.class));
                    sharedPreferences.edit().putString(Constants.INSURANCE_DOC,professional_image).apply();
                    finish();
                }
                 else
                    UtilsManager.showAlertMessage(Upload_Insurance_Picture_Registeration.this,"","Please provide a document");
