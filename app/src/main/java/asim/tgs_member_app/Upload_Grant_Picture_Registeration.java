...
public class Upload_Grant_Picture_Registeration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  if (Constants.hasProfessionalImage) {
        ...
        btnSkip_upload_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), Upload_Insurance_Picture_Registeration.class));
                sharedPreferences.edit().putString(Constants.GRANT_DOC,"").apply();
                finish();
            }
        });
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isImageChosen) {
                    startActivity(new Intent(getApplicationContext(), Upload_Insurance_Picture_Registeration.class));
                    sharedPreferences.edit().putString(Constants.GRANT_DOC,professional_image).apply();
                    finish();
                }
                 else
                   UtilsManager.showAlertMessage(Upload_Grant_Picture_Registeration.this,"","Please provide a document");
