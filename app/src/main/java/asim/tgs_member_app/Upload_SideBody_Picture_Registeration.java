...
public class Upload_SideBody_Picture_Registeration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload__sidebody__picture__registeration);


        sharedPreferences = getSharedPreferences(Constants.PREFS_NAME,MODE_PRIVATE);
       /* if (Constants.hasProfessionalImage) {
            startActivity(new Intent(Upload_SideBody_Picture_Registeration.this, Upload_Driving_License_Registeration.class).putExtra("professional", ""));
            finish();
        }*/
        ...
        String doc_name = sharedPreferences.getString(Constants.SIDEBODY_DOC,"no");
        ...
        btnSkip_upload_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), Upload_IC_Picture_Registeration.class));
                sharedPreferences.edit().putString(Constants.SIDEBODY_DOC,"").apply();
                finish();
            }
        });
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isImageChosen) {
                    startActivity(new Intent(getApplicationContext(), Upload_IC_Picture_Registeration.class));
                    sharedPreferences.edit().putString(Constants.SIDEBODY_DOC,professional_image).apply();
                    finish();
                }
                 else
                    UtilsManager.showAlertMessage(Upload_SideBody_Picture_Registeration.this,"","Please provide a body picture");
