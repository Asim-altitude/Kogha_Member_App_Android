 ...
 * @author Sohaib
 */
public class MOServiceType extends BaseModel {

	private String status;
	private String message;
	private int errorCode;
	private ArrayList<MOServiceTypeList> data;
	...
	public ArrayList<MOServiceTypeList> getData() {
		return data;
	}

	public void setData(ArrayList<MOServiceTypeList> data) {
		this.data = data;
	}
}
